const Notification = ({ srNicks }) => {
    ...
    return (
        <div className="fixed top-0 right-0 z-50 flex items-center justify-center">
            <div className="fixed top-5 right-5 flex flex-col bg-white text-black dark:bg-slate-700 dark:text-gray-300 rounded-3xl border">
                <div className="flex justify-between p-3 border-gray-200 dark:border-gray-600">
                    {status ? (
                        <span className="pl-2">
