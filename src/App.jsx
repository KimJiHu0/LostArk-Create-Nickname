...
// Reducer
import { apiKeyReducer, searchNickNameReducer } from './assets/js/reducers/reducer';
...
export default function App() {
    ...
    return (
        <rootContext.Provider value={{ apiKey, apiKeyDispatch, searchNickNames, searchNickNamesDispatch }}>
